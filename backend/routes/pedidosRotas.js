...
router.post('/cliente/', PedidosController.Criar);                   // POST /api/v1/pedidos/cliente/
...
router.post('/restaurante/status/:id', PedidosController.Status);    // POST /api/v1/pedidos/status/:id
